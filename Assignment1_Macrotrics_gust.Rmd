...
rmse_ar <- function(ts_data, lag_order, holdout_period) {
  ...
  ar_model <- ar(ts_data_train, order.max = lag_order)
...
rmse_ar(na.omit(USINDPRO_1$yoy), 6, 12)
rmse_ar(na.omit(USINDPRO_1$yoy), 7, 12)
rmse_ar(na.omit(USINDPRO_1$yoy), 8, 12)
rmse_ar(na.omit(USINDPRO_1$yoy), 9, 12)
```
