...
```{r, echo=FALSE}
# Supply shock
irf_supply_shock_stock <- irf(mod1, impulse = "GOPC", response = "RPO", boot = TRUE, cumulative = TRUE, n.ahead = 15)
...
# Aggregate-demand shock
irf_agg_demand_shock_stock <- irf(mod1, impulse = "GRA", response = "RPO", boot = TRUE, cumulative = TRUE, n.ahead = 15)

# Oil specific-demand shock
irf_oi_specific_demand_shock <- irf(mod1, impulse = "RPO", response = "RPO", boot = TRUE, cumulative = TRUE, n.ahead = 15)
```
