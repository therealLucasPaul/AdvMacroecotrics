...
# Figure 1
par(mar = c(4, 4, .1, .1))
plot(irf_supply_specific_shocks, ylim=c(-6,12))

plot(irf_agg_demand_shocks, ylim=c(-6,12))

plot(irf_oi_specific_demand_shocks, ylim=c(-6,12))
```
