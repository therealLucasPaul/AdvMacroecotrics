...
Unexpected demand shocks significantly decrease dividend growth rates. 
...
The shock in oil production leads to an increase in the price of real oil for several periods, approximately until the 6th one. It is then followed by a decline in the price for the following periods going under initial levels after period 10th. A positive shock to the aggregate demand results in a sustained increase in the price of oil over time. Finally, a positive shock in the oil-specific demand leads to a steep increase in the price of oil in the following period. However, the effect seems to decrease over time such that the increase in price in the period following the shock is higher than the increase that results in the latest periods. Also, note that we obtain a response above the one-standard error band which would imply a significant effect, however, it is certainly due to differences in the bootstrap construction. In general, the three shocks impact differently the oil price, and all carry the impact of a one-period shock in later periods. The results of Figure 1 are consistent with the one from Killian & Park 2009.
